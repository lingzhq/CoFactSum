...
class FactSumm:
    ...
    def __call__(
        ...
        for i, (source, summary) in tqdm(enumerate(zip(sources, summaries)), total=num_pairs):
        ...
        return {
            ...
            # "bert_score": {
            #     "precision": bert_scores[0] / num_pairs,
            #     "recall": bert_scores[1] / num_pairs,
            #     "f1": bert_scores[2] / num_pairs,
            # },
        }
